$(function () {
    ...
    /*$('.custom-glyhpicon-search').on('click',function(){
     if($("#searchField").css('display')=='block'){
     $("#searchField").css('display','none');
     }
     else if($("#searchField").css('display')=='none'){
    ...
    $("#bars-static li .bar").each(function (key, bar) {
        var percentage = $(this).data('percentage') / 2;
    ...
    function changeGraphVal(arr)
    {
        $('#bars li .bar1').attr('data-percentage', arr[0]);
        $('#bars li .bar2').attr('data-percentage', arr[1]);
        $('#bars li .bar3').attr('data-percentage', arr[2]);
        $('#bars li .bar4').attr('data-percentage', arr[3]);
        $('#bars li .bar5').attr('data-percentage', arr[5]);
...
$("#pieChart").drawPieChart([
    { title: "",              value : 55,  color: "#5b9cd6" },
    { title: "",    value:  20,   color: "#ed7d31" },
    { title: "",          value:  7,   color: "#a5a5a5" },
    { title: "", value : 8,   color: "#ffc002" },
    { title: "",      value : 10,   color: "#4473c5" }
  ]);
});
...
;(function($, undefined) {
  $.fn.drawPieChart = function(data, options) {
    ...
    function pathMouseEnter(e){
      ...
      $tip.text( data[index].value +'%').fadeIn(200);
